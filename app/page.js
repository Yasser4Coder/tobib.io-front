...
const page = () => {
  ...
  return (
    ...
    <div className='main container'>
        ...
        <div className="content text-center flex flex-col gap-[60px]">
        ...
        <div className="image xl:relative bg-slate-600">
            <Image 
            ...
            />
            <div className="card xl:absolute xl:top-[270px] xl:right-[90px] w-[500px] h-[358px] rounded-2xl bg-gray-300 px-[50px] pt-[40px] flex flex-col gap-[15px]">
                <Image
