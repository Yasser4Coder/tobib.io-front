...
const page = () => {
  return (
    ...
    <div className="chat container w-full">
        <div className="chatbox mx-auto w-[900px] flex-col-reverse flex flex-col h-screen shadow-2xl">
             
<form className='flex-col-reverse'>   
